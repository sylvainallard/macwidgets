...
public class MacFontUtils {
    ...
    public static final Font BOLD_LABEL_FONT =
    	    UIManager.getFont("Label.font") != null ? UIManager.getFont("Label.font").deriveFont(Font.BOLD, DEFAULT_FONT_SIZE) : DEFAULT_FONT.deriveFont(Font.BOLD, DEFAULT_FONT_SIZE);
